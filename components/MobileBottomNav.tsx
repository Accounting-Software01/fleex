...
export default function MobileBottomNav() {
  ...
  // Only show on specified pages when user is authenticated (also covers
  // nested routes like /profile/[username] or /messages/[conversationId])
  const onNavPage = navPages.some(
